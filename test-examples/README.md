...
node scripts/embed-snippets.js c            # index.html
```

### 3. Commit Changes

```bash
git add snippets/ scripts/ *.c *.txt *.sh index.html*
...
| All snippets | `../../index.html` | Website with syntax highlighting |
...
### 3. embed-snippets.js
- Reads `../../index.html.tpl` (template with placeholders)
- For each snippet:
